...
export function Sidebar({ onClose }: SidebarProps) {
  ...
  return (
    <div style={{
      ...
      {/* Logo */}
      <div style={{ padding: '0 8px 24px', borderBottom: '1px solid #0f1923', marginBottom: '16px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          <div style={{
            width: '36px', height: '36px', borderRadius: '10px',
            background: 'linear-gradient(135deg, #16a34a, #15803d)',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            flexShrink: 0, boxShadow: '0 0 16px rgba(22,163,74,0.3)'
          }}>
      ...
      <nav style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '2px' }}>
        <div style={{ fontSize: '10px', fontWeight: 700, color: '#64748b', letterSpacing: '0.1em', textTransform: 'uppercase', padding: '0 12px', marginBottom: '8px' }}>
          Main Menu
        </div>
      ...
      {/* User + logout */}
      <div style={{ borderTop: '1px solid #0f1923', paddingTop: '16px', marginTop: '8px' }}>
        <div style={{ padding: '10px 12px', borderRadius: '10px', marginBottom: '4px' }}>
        ...
        <button
          ...
          className="sidebar-link"
          style={{ width: '100%', border: 'none', color: '#ef4444', background: 'none' }}
        >
          <LogOut size={16} />
          Sign Out
        </button>
